...
class MainTabBarController: UITabBarController {
    ...
    func setupVCs() {
        if let user = Auth.auth().currentUser {
          ...
          //self.present(channelsViewController, animated: true, completion: nil)
            ...
            viewControllers = [
                createNavController(for: DriveViewController(), title: NSLocalizedString("My Sheet", comment: ""), image: UIImage(systemName: "house.fill")!),
                createNavController(for: channelsvc, title: NSLocalizedString("Chat", comment: ""), image: UIImage(systemName: "message.fill")!),
                
                createNavController(for: MoreViewController(), title: NSLocalizedString("More", comment: ""), image: UIImage(systemName: "ellipsis.circle.fill")!)
            ]
    ...
    func createNavController(for rootViewController: UIViewController,
        ...
        navController.navigationBar.backgroundColor = #colorLiteral(red: 0.9715676904, green: 0.9767020345, blue: 0.9721227288, alpha: 1)
